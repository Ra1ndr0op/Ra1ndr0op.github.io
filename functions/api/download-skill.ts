type SkillName = "stardew-valley-poster" | "minecraft-voxel-poster" | "consulting-cover-prompt";
...
const skillFiles: Record<SkillName, string> = {
  ...
  "consulting-cover-prompt": "/downloads/skills/consulting-cover-prompt/SKILL.md",
};
...
function isSkillName(value: string | null): value is SkillName {
  return value === "stardew-valley-poster" || value === "minecraft-voxel-poster" || value === "consulting-cover-prompt";
}
